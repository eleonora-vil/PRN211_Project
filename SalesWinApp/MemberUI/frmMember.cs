...
namespace SalesWinApp
{
    public partial class frmMember : Form
    {
        ...
        {
            InitializeComponent();
            this.Activated += new EventHandler(frmMember_Activated);
        }
        private void frmMember_Activated(object sender, EventArgs e)
        {
            // Call the LoadMemberList method to reload the data.
            LoadMemberList();
        }
        ...
        private void btnLogOut_Click(object sender, FormClosingEventArgs e)
        {
            if (exitConfirm())
            {
